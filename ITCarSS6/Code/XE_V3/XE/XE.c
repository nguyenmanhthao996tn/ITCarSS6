            ...
            switch(pattern)
                {
					...
					/*#pragma region Chuyen_Line
					case 51: //PHAI
					//set_encoder(20);
					if ((sensor_cmp(0b11100000) == 0b11100000) || (sensor_cmp(0b11110000) == 0b11110000))
					{
					pattern = 21 ;
					break;
					}
					...
					case 53:
					if( sensor_cmp(0b11111111) == 0b00000000 )
					{
					handle( 90 );
					speed( 40 ,70 );
					pattern = 54;
					...
					case 54:
					if( sensor_cmp( 0b00001100 ) == 0b00001100 )
					{
					pattern = 1;
					cnt1 = 0;
					handle(-15);
					...
					case 61:	// Xu ly khi gap vach tin hieu chuyen lan trai dau tien
					//set_encoder(20);
					if ( (sensor_cmp(0b00000111) == 0b00000111) || (sensor_cmp(0b00001111) == 0b00001111) )
					{
					pattern = 21 ;
					break;
					}
					...
					case 64:
					if( sensor_cmp( 0b00110000 ) == 0b00110000 )
					{
					pattern = 1;
					cnt1 = 0;
					led7(0);
